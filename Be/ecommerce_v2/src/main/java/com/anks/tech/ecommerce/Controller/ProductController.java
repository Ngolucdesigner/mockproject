...
import com.anks.tech.ecommerce.DTO.ProductDTO.ProductDTO;
...
import com.anks.tech.ecommerce.Validate.Product.ProductIdNotExists;
...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductDTO>> getAllProductAdmin(Pageable pageable, ProductFilterForm form) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProductDTO> getProductById(@PathVariable("id") @ProductIdNotExists int id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<String> deleteProduct(@PathVariable @ProductIdNotExists int id){
