...
export const post1 = async <T>(path: string, options?: RequestOptions, data?: any): Promise<T> => {
...
export const delete1 = async <T>(path: string, options?: RequestOptions): Promise<T> => {
